    ...
    <div className="relative bg-white overflow-hidden">
      <section>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">Post</span>{" "}
                  <span className="block text-indigo-600 xl:inline">CMS</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Create your own website in milliseconds.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 ">
          <img
            className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-100"
            src="https://images.unsplash.com/photo-1426024120108-99cc76989c71?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1174&q=80"
            alt=""
          />
        </div>
      </section>
      ...
      >
        <div className="">
          ...
          <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
            ...
            posts that has been sent. People can either like, dislike, share and
            comment on the posts.
          </p>
        </div>
        <div className="hidden md:block w-5/12 md:ml-6">
          <img src="CMS photoo.svg"></img>
        </div>
      </section>
      <section
        id="about-block"
        className="flex flex-nowrap justify-between mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28"
      >
        <div className="hidden md:block w-5/12 md:mr-6">
          <img src="CMS photo.svg"></img>
        </div>
        <div className="mb-10">
          <div>
            <p className="mt-4 text-3xl sm:text-4xl text-slate-900 font-extrabold tracking-tight dark:text-slate-50 ">
